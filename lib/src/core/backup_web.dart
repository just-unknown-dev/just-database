...
class BackupManager {
  ...
  // ---------------------------------------------------------------------------
  // File-based helpers — not supported on web
  // ---------------------------------------------------------------------------
  ...
  static Future<void> backupToFile(
    ...
    throw UnsupportedError(
      'backupToFile is not supported on the web platform.',
    );
  }
  ...
  static Future<int> restoreFromFile(
    ...
    throw UnsupportedError(
      'restoreFromFile is not supported on the web platform.',
    );
  }
  ...
  static Future<void> backupToJsonFile(
    ...
    throw UnsupportedError(
      'backupToJsonFile is not supported on the web platform.',
    );
  }
  ...
  static Future<int> restoreFromJsonFile(
    ...
    throw UnsupportedError(
      'restoreFromJsonFile is not supported on the web platform.',
    );
  }
